...
function EditContact(props) {
    ...
    return(
        <tr>
            <td><input className="from-control" name="name" value={props.contact.name} onChange={handleChange}/></td>
            <td><input className="from-control" name="phone" value={props.contact.phone} onChange={handleChange}/></td>
            <td>
